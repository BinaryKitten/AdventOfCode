 ...
 * While travel by toboggan might be easy, it's certainly not safe: there's very minimal steering and the area is
 * covered in trees.
...
echo 'You Hit ' . $cv['X'] . ' Trees' . "\n";

// Your puzzle answer was 200.

function traverse(array $map): array
{
    $lastRow = count($map);
    $coords = ['x' => 0, 'y' => 0];
    do {
