 ...
 *      but somehow, you'll need to find fifty of these coins by the time you arrive so you can pay the deposit
 *      on your room.
 *
 ...
 *
 * Before you leave, the Elves in accounting just need you to fix your expense report (your puzzle input.txt);
...
foreach ($input as $idx => $number) {
    for ($i = $idx + 1, $l = count($input); $i < $l; $i++) {
        $number2 = $input[$i];
