 ...
 *  continue to the instruction immediately below it, and jmp -20 would cause the instruction 20 lines above
 *  to be executed next.
...
$testBootFile = loadBootFile(__DIR__ . '/test.txt');
$testAccumulator = calculatorAccumulator($testBootFile, false);

$bootFile = loadBootFile(__DIR__ . '/input.txt');
$accumulator = calculatorAccumulator($bootFile, false);

echo 'TEST Result: ' . $testAccumulator . "\n";
