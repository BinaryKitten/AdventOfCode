...
$testBoardingPasses = parseFileToBoardingPasses(__DIR__ . '/test.txt');
$boardingPasses = parseFileToBoardingPasses(__DIR__ . '/input.txt');

$testSeats = array_map('convertBoardingPassToSeatDetails', $testBoardingPasses);
$seats = array_map('convertBoardingPassToSeatDetails', $boardingPasses);

$testHighest = max(array_column($testSeats, 'seatId'));
$highest = max(array_column($seats, 'seatId'));

echo 'Test Result: ' . $testHighest . "\n";
echo 'Result: ' . $highest . "\n";
