 ...
 * Then, you could determine the output signal that gets sent from amplifier E to the
 ...
 *      output signal was produced from amplifier A. It will then produce a new output signal destined for amplifier C.
