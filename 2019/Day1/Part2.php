 ...
 * (2 divided by 3 and rounded down is 0, which would call for a negative fuel), so the total fuel
...
echo 'Result: ' . $totalFuel . "\n\n";

// Your puzzle answer was 5073456.
