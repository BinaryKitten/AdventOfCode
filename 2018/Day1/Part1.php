 ...
 * She sounded pretty worried when she called you down here. "At 500-year intervals into the past, someone has
 * been changing Santa's history!"
 *
 * "The good news is that the changes won't propagate to our time stream for another 25 days,
 * and we have a device" - she attaches something to your wrist - "that will let you fix the changes with no such
 * propagation delay.
...
function generate_result(array $data): int
{
...
echo 'Result: ' . generate_result($data) . "\n\n";
