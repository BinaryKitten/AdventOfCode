 ...
 * We can't print the Naughty or Nice List!" By the time you make it to sub-basement 17, there are only a few
 * minutes until midnight. "We have a big problem," she says; "there must be almost fifty bugs in this system,
 * but nothing else can print The List. Stand in this square, quick! There's no time to explain; if you can
...
$numbers = [];
for ($i = 0, $l = strlen($data) - 1; $i < $l; $i++) {
    $thisNum = $data[$i];
    $nextNum = $data[$i + 1];
    if ((int)$thisNum === (int)$nextNum) {
        $numbers[] = $thisNum;
    }
}
